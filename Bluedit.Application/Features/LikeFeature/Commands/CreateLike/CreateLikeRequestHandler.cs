...
internal sealed class CreateLikeRequestHandler<T> : IRequestHandler<CreateLikeRequest<T>, LikesDto>
    where T : LikeBase, new()
{
    ...
    public CreateLikeRequestHandler(IMapper mapper, ILikesRepository<T> likeRepository, IPostRepository postRepository,
